# 8b LED Binary Counter Functions II Python program example:
...
# Create three functions called:

# clear_all_data_bits
# binary_for_loop_reverse
# binary_for_loop_forward
